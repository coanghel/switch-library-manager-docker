...
import (
	"errors"
	"fmt"
	"github.com/coanghel/switch-library-manager/fileio"
	"github.com/coanghel/switch-library-manager/settings"
	"github.com/coanghel/switch-library-manager/switchfs"
	"go.uber.org/zap"
	"os"
	"path/filepath"
	"regexp"
